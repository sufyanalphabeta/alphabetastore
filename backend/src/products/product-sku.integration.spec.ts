...
function setup(options: { generated?: string; createError?: unknown } = {}) {
  ...
  const service = new ProductsService(prisma as never, {} as never, {} as never, cache as never, sku as never, {} as never, { productUpdateInvalidates: () => false, invalidationData: () => ({}) } as never, {} as never);
